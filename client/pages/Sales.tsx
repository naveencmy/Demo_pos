...
export default function Sales() {
  ...
  useEffect(() => {
    if (!canUsePayments && summaryTab === "payment") {
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <button
                      disabled={cart.length === 0 || !canUsePayments}
